...
public class RoundRobinWithFailOverLoadBalancerTest extends CamelTestSupport{
    ...
    public void setup() throws Exception {
        ...
        context.getRouteDefinition("roundRobinFailOverRoute").adviceWith(context, new AdviceWithRouteBuilder() {
            @Override
    ...
    protected RoutesBuilder createRouteBuilder() throws Exception {
        return new RoundRobinWithFailOverLoadBalancer();
    }
