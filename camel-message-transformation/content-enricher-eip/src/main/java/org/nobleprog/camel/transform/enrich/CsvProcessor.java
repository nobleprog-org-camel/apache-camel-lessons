...
public class CsvProcessor implements Processor {
    ...
    public void process(Exchange exchange) throws Exception {
        ...
        tradesCsv.append("ID,").append("BUY/SELL,").append("QUANTITY,").append("TradeDate,").append("SettlementDate").append("\r\n");
        ...
        for(String body : trades){
            ...
            String tradeDate = body.substring(11,22).replaceAll("-","");
            String settlementDate = body.substring(22).replaceAll("-","");

            tradesCsv.append(orderId)
                    .append(",").append(buySell)
                    .append(",").append(qty)
                    .append(",").append(tradeDate)
                    .append(",").append(settlementDate)
                    .append("\r\n");
        }
